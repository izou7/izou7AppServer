 ...
 */
@Repository
public class ActivityRegistrationDao extends AdvancedHibernateDao<ActivityRegistration>{

	public boolean exists(Activity activity, User user) {
		Criteria criteria = this.getCurrentSession().createCriteria(ActivityRegistration.class);
